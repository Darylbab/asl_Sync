...
namespace asl_SyncLibrary
{
    public class OBI4POS
    {
        ...
        {
            //if (CF.IsURLOnline(Properties.Settings.Default.Axess_OBI4POS))
            //{
            ...
            try
            {
                ...
                if ((TErrorNo == 0) || (TErrorNo == -667) || (TErrorNo == 403) || (TErrorNo == 404) || (TErrorNo == 405))
                {
                    return Serverstatus.Active;
                }
            }
        ...
        public XmlDocument Execute(XmlDocument requestDoc)
        {
            ...
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(Properties.Settings.Default.Axess_OBI4POS);
            ...
            {
                if (ex.Message.Contains("The remote server"))
                {
                    TErrorMsg = ex.Message;
                    TErrorNo = Convert.ToInt32(ex.Message.Substring(38, 3));
